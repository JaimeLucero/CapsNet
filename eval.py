...
if __name__ == '__main__':
    ...
    weights_files = [f for f in os.listdir(cfg.logdir) if f.endswith('.weights.h5')]
    ...
    latest_weights_path = os.path.join(cfg.logdir, latest_weights_file)

    # Load the model weights
    capsNet.load_weights(latest_weights_path)
    ...
    for i in range(22500 // cfg.batch_size):
        ...
        class_output, recon_imgs = capsNet(teX[start:end])  # Unpack outputs
