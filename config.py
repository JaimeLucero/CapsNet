...
flags.DEFINE_float('m_plus', 0.7, 'the parameter of m plus')
flags.DEFINE_float('m_minus', 0.05, 'the parameter of m minus')
flags.DEFINE_float('lambda_val', 0.0005, 'down weight of the loss for absent digit classes')
...
#   environment setting    #
############################
flags.DEFINE_string('dataset', 'data/ricedatanew', 'the path for dataset')
flags.DEFINE_boolean('is_training', True, 'train or predict phase')
flags.DEFINE_integer('num_threads', 8, 'number of threads of enqueueing exampls')
flags.DEFINE_string('logdir', 'logdir', 'logs directory')
flags.DEFINE_string('model', 'capsNet', 'set to capsNet or resCapsNet')
